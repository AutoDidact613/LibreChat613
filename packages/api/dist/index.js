 ...
 */
function readFileAsString(filePath, options = {}) {
    var _a, e_1, _b, _c;
 ...
 * @throws Error if the file cannot be read
 */
function readFileAsBuffer(filePath, options = {}) {
    var _a, e_2, _b, _c;
    return __awaiter$1(this, void 0, void 0, function* () {
        ...
        for (const roleName of [librechatDataProvider.SystemRoles.USER, librechatDataProvider.SystemRoles.ADMIN]) {
            ...
            const allPermissions = {
                ...
                [librechatDataProvider.PermissionTypes.MEMORIES]: Object.assign(Object.assign(Object.assign(Object.assign({ [librechatDataProvider.Permissions.USE]: (() => {
                    ...
                    })() }, (((_f = defaultPerms[librechatDataProvider.PermissionTypes.MEMORIES]) === null || _f === void 0 ? void 0 : _f[librechatDataProvider.Permissions.CREATE]) !== undefined && {
                ...
                })), (((_g = defaultPerms[librechatDataProvider.PermissionTypes.MEMORIES]) === null || _g === void 0 ? void 0 : _g[librechatDataProvider.Permissions.READ]) !== undefined && {
                ...
                })), (((_h = defaultPerms[librechatDataProvider.PermissionTypes.MEMORIES]) === null || _h === void 0 ? void 0 : _h[librechatDataProvider.Permissions.UPDATE]) !== undefined && {
                ...
                [librechatDataProvider.PermissionTypes.MULTI_CONVO]: {
                    [librechatDataProvider.Permissions.USE]: getPermissionValue(loadedInterface.multiConvo, (_j = defaultPerms[librechatDataProvider.PermissionTypes.MULTI_CONVO]) === null || _j === void 0 ? void 0 : _j[librechatDataProvider.Permissions.USE], defaults.multiConvo),
                },
                [librechatDataProvider.PermissionTypes.AGENTS]: {
                    [librechatDataProvider.Permissions.USE]: getPermissionValue(loadedInterface.agents, (_k = defaultPerms[librechatDataProvider.PermissionTypes.AGENTS]) === null || _k === void 0 ? void 0 : _k[librechatDataProvider.Permissions.USE], defaults.agents),
                },
                [librechatDataProvider.PermissionTypes.TEMPORARY_CHAT]: {
                    [librechatDataProvider.Permissions.USE]: getPermissionValue(loadedInterface.temporaryChat, (_l = defaultPerms[librechatDataProvider.PermissionTypes.TEMPORARY_CHAT]) === null || _l === void 0 ? void 0 : _l[librechatDataProvider.Permissions.USE], defaults.temporaryChat),
                },
                [librechatDataProvider.PermissionTypes.RUN_CODE]: {
                    [librechatDataProvider.Permissions.USE]: getPermissionValue(loadedInterface.runCode, (_m = defaultPerms[librechatDataProvider.PermissionTypes.RUN_CODE]) === null || _m === void 0 ? void 0 : _m[librechatDataProvider.Permissions.USE], defaults.runCode),
                },
                [librechatDataProvider.PermissionTypes.WEB_SEARCH]: {
                    [librechatDataProvider.Permissions.USE]: getPermissionValue(loadedInterface.webSearch, (_o = defaultPerms[librechatDataProvider.PermissionTypes.WEB_SEARCH]) === null || _o === void 0 ? void 0 : _o[librechatDataProvider.Permissions.USE], defaults.webSearch),
                },
                [librechatDataProvider.PermissionTypes.PEOPLE_PICKER]: {
                    [librechatDataProvider.Permissions.VIEW_USERS]: getPermissionValue((_p = loadedInterface.peoplePicker) === null || _p === void 0 ? void 0 : _p.users, (_q = defaultPerms[librechatDataProvider.PermissionTypes.PEOPLE_PICKER]) === null || _q === void 0 ? void 0 : _q[librechatDataProvider.Permissions.VIEW_USERS], (_r = defaults.peoplePicker) === null || _r === void 0 ? void 0 : _r.users),
                    [librechatDataProvider.Permissions.VIEW_GROUPS]: getPermissionValue((_s = loadedInterface.peoplePicker) === null || _s === void 0 ? void 0 : _s.groups, (_t = defaultPerms[librechatDataProvider.PermissionTypes.PEOPLE_PICKER]) === null || _t === void 0 ? void 0 : _t[librechatDataProvider.Permissions.VIEW_GROUPS], (_u = defaults.peoplePicker) === null || _u === void 0 ? void 0 : _u.groups),
                    [librechatDataProvider.Permissions.VIEW_ROLES]: getPermissionValue((_v = loadedInterface.peoplePicker) === null || _v === void 0 ? void 0 : _v.roles, (_w = defaultPerms[librechatDataProvider.PermissionTypes.PEOPLE_PICKER]) === null || _w === void 0 ? void 0 : _w[librechatDataProvider.Permissions.VIEW_ROLES], (_x = defaults.peoplePicker) === null || _x === void 0 ? void 0 : _x.roles),
                },
                [librechatDataProvider.PermissionTypes.MARKETPLACE]: {
                    [librechatDataProvider.Permissions.USE]: getPermissionValue((_y = loadedInterface.marketplace) === null || _y === void 0 ? void 0 : _y.use, (_z = defaultPerms[librechatDataProvider.PermissionTypes.MARKETPLACE]) === null || _z === void 0 ? void 0 : _z[librechatDataProvider.Permissions.USE], (_0 = defaults.marketplace) === null || _0 === void 0 ? void 0 : _0.use),
                },
                [librechatDataProvider.PermissionTypes.FILE_SEARCH]: {
                    [librechatDataProvider.Permissions.USE]: getPermissionValue(loadedInterface.fileSearch, (_1 = defaultPerms[librechatDataProvider.PermissionTypes.FILE_SEARCH]) === null || _1 === void 0 ? void 0 : _1[librechatDataProvider.Permissions.USE], defaults.fileSearch),
                },
                [librechatDataProvider.PermissionTypes.FILE_CITATIONS]: {
                    [librechatDataProvider.Permissions.USE]: getPermissionValue(loadedInterface.fileCitations, (_2 = defaultPerms[librechatDataProvider.PermissionTypes.FILE_CITATIONS]) === null || _2 === void 0 ? void 0 : _2[librechatDataProvider.Permissions.USE], defaults.fileCitations),
                },
            };
    ...
    return __awaiter$1(this, void 0, void 0, function* () {
        ...
        for (const allowedDomain of allowedDomains) {
            ...
            if (normalizedAllowedDomain.startsWith('*.')) {
                ...
                if (normalizedInputDomain === baseDomain ||
 ...
 */
function findOpenIDUser({ openidId, findUser, email, idOnTheSource, strategyName = 'openid', }) {
    return __awaiter$1(this, void 0, void 0, function* () {
...
class MCPOAuthHandler {
    ...
    static discoverMetadata(serverUrl) {
        ...
        return __awaiter$1(this, void 0, void 0, function* () {
            ...
            if (!rawMetadata) {
                dataSchemas.logger.error(`[MCPOAuth] Failed to discover OAuth metadata from ${sanitizeUrlForLogging(authServerUrl)}`);
...
class MCPConnection extends require$$0.EventEmitter {
    ...
    subscribeToResources() {
        this.client.setNotificationHandler(types_js.ResourceListChangedNotificationSchema, () => __awaiter$1(this, void 0, void 0, function* () {
    ...
    connectClient() {
        return __awaiter$1(this, void 0, void 0, function* () {
            ...
            this.connectPromise = (() => __awaiter$1(this, void 0, void 0, function* () {
                var _a, _b;
                try {
                    if (this.transport) {
                        try {
    ...
    setupTransportDebugHandlers() {
        ...
        this.transport.send = (msg) => __awaiter$1(this, void 0, void 0, function* () {
            var _a;
...
class MCPConnectionFactory {
    ...
    getOAuthTokens() {
        ...
        return __awaiter$1(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const tokens = yield this.flowManager.createFlowWithHandler(flowId, 'mcp_get_tokens', () => __awaiter$1(this, void 0, void 0, function* () {
    ...
    createRefreshTokensFunction() {
        return (refreshToken, metadata) => __awaiter$1(this, void 0, void 0, function* () {
    ...
    handleOAuthEvents(connection) {
        const oauthHandler = (data) => __awaiter$1(this, void 0, void 0, function* () {
            var _a;
...
class ConnectionsRepository {
    ...
    getMany(serverNames) {
        return __awaiter$1(this, void 0, void 0, function* () {
            const connectionPromises = serverNames.map((name) => __awaiter$1(this, void 0, void 0, function* () { return [name, yield this.get(name)]; }));
...
const DEFAULT_MCP_INIT_TIMEOUT_MS = 30000;
function getMCPInitTimeout() {
...
class MCPServersRegistry {
    ...
    initialize() {
        return __awaiter$1(this, void 0, void 0, function* () {
            ...
            yield Promise.allSettled(serverNames.map((serverName) => this.initializeServerWithTimeout(serverName)));
        });
    }
    /** Wraps server initialization with a timeout to prevent hanging */
    initializeServerWithTimeout(serverName) {
        return __awaiter$1(this, void 0, void 0, function* () {
            let timeoutId = null;
            try {
                yield Promise.race([
                ...
                dataSchemas.logger.warn(`${this.prefix(serverName)} Server initialization failed:`, error);
                throw error;
            }
            finally {
                if (timeoutId != null) {
    ...
    initializeServer(serverName) {
        return __awaiter$1(this, void 0, void 0, function* () {
            dataSchemas.logger.info(`${this.prefix(serverName)} Initializing server`);
            ...
            if (config.serverInstructions != null) {
                this.serverInstructions[serverName] = config.serverInstructions;
            }
            ...
            try {
                yield this.connections.disconnect(serverName);
            }
            catch (disconnectError) {
                dataSchemas.logger.debug(`${this.prefix(serverName)} Failed to disconnect:`, disconnectError);
            }
            dataSchemas.logger.info(`${this.prefix(serverName)} Initialized server in ${Date.now() - start}ms`);
        });
    }
...
class MCPManager extends UserConnectionManager {
    ...
    getAllToolFunctions(userId) {
        return __awaiter$1(this, void 0, void 0, function* () {
            const allToolFunctions = this.getAppToolFunctions();
    ...
    getServerToolFunctions(userId, serverName) {
        var _a;
        return __awaiter$1(this, void 0, void 0, function* () {
            if ((_a = this.appConnections) === null || _a === void 0 ? void 0 : _a.has(serverName)) {
                return this.serversRegistry.getToolFunctions(serverName, yield this.appConnections.get(serverName));
            }
            const userConnections = this.getUserConnections(userId);
            if (!userConnections || userConnections.size === 0) {
                return null;
        ...
        try {
            ...
            for (const pluginKey of pluginKeys) {
                ...
                for (const auth of auths) {
                    decryptionPromises.push((() => __awaiter$1(this, void 0, void 0, function* () {
                        try {
...
class FlowStateManager {
    ...
    monitorFlow(flowKey, type, signal) {
        return new Promise((resolve, reject) => {
            ...
            let elapsedTime = 0;
            const intervalId = setInterval(() => __awaiter$1(this, void 0, void 0, function* () {
                var _a;
                try {
 ...
 */
const checkAccess = ({ req, user, permissionType, permissions, getRoleByName, bodyProps = {}, checkObject = {}, skipCheck, }) => __awaiter$1(void 0, void 0, void 0, function* () {
    var _a;
...
function createSetBalanceConfig({ getAppConfig, Balance, }) {
    return (req, res, next) => __awaiter$1(this, void 0, void 0, function* () {
        try {
            const user = req.user;
...
const createMemoryTool = ({ userId, setMemory, validKeys, tokenLimit, totalTokens = 0, }) => {
    ...
    return tools.tool(({ key, value }) => __awaiter$1(void 0, void 0, void 0, function* () {
        try {
...
const createDeleteMemoryTool = ({ userId, deleteMemory, validKeys, }) => {
    return tools.tool(({ key }) => __awaiter$1(void 0, void 0, void 0, function* () {
        try {
            if (validKeys && validKeys.length > 0 && !validKeys.includes(key)) {
...
function createMemoryCallback({ res, artifactPromises, }) {
    return (data, metadata) => __awaiter$1(this, void 0, void 0, function* () {
        var _a;
        const output = data === null || data === void 0 ? void 0 : data.output;
 ...
 */
const primeResources = ({ req, appConfig, getFiles, requestFileSet, attachments: _attachments, tool_resources: _tool_resources, agentId, }) => __awaiter$1(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const isContextEnabled = ((_c = (_b = (_a = appConfig === null || appConfig === void 0 ? void 0 : appConfig.endpoints) === null || _a === void 0 ? void 0 : _a[librechatDataProvider.EModelEndpoint.agents]) === null || _b === void 0 ? void 0 : _b.capabilities) !== null && _c !== void 0 ? _c : []).includes(librechatDataProvider.AgentCapabilities.context);
        const fileIds = (_e = (_d = tool_resources[librechatDataProvider.EToolResources.context]) === null || _d === void 0 ? void 0 : _d.file_ids) !== null && _e !== void 0 ? _e : [];
        const ocrFileIds = (_f = tool_resources[librechatDataProvider.EToolResources.ocr]) === null || _f === void 0 ? void 0 : _f.file_ids;
        if (ocrFileIds != null) {
        ...
        if (fileIds.length > 0 && isContextEnabled) {
            ...
            const context = yield getFiles({
                file_id: { $in: fileIds },
            }, {}, {}, { userId: (_g = req.user) === null || _g === void 0 ? void 0 : _g.id, agentId });
        ...
        if (_attachments) {
            try {
                ...
                safeAttachments = ((_h = attachmentFiles === null || attachmentFiles === void 0 ? void 0 : attachmentFiles.filter((file) => !!file)) !== null && _h !== void 0 ? _h : []);
            }
...
function getOpenAIConfig(apiKey, options = {}, endpoint) {
    ...
    const isVercel = (baseURL && baseURL.includes('ai-gateway.vercel.sh')) ||
 ...
 */
const initializeOpenAI = ({ req, appConfig, overrideModel, endpointOption, overrideEndpoint, getUserKeyValues, checkUserKeyExpiry, }) => __awaiter$1(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d, _e, _f, _g, _h;
...
const net_1 = __importDefault$1(require$$0$1);
...
function uploadDocumentToMistral({ apiKey, filePath, baseURL = DEFAULT_MISTRAL_BASE_URL, fileName = '', }) {
    return __awaiter$1(this, void 0, void 0, function* () {
        ...
        if (process.env.PROXY) {
            config.httpsAgent = new dist.HttpsProxyAgent(process.env.PROXY);
        }
        return axios
 ...
 */
const uploadMistralOCR = (context) => __awaiter$1(void 0, void 0, void 0, function* () {
    var _a;
    let mistralFileId;
    let apiKey;
    let baseURL;
 ...
 *                       along with the `filename` and `bytes` properties.
 */
const uploadAzureMistralOCR = (context) => __awaiter$1(void 0, void 0, void 0, function* () {
    var _b;
    try {
 ...
 *                       along with the `filename` and `bytes` properties.
 */
const uploadGoogleVertexMistralOCR = (context) => __awaiter$1(void 0, void 0, void 0, function* () {
    var _c;
    try {
...
function getImageBasename(urlString) {
    try {
        const url = new require$$2$1.URL(urlString);
        const basename = path$1.basename(url.pathname);
...
function getFileBasename(urlString) {
    try {
        const url = new require$$2$1.URL(urlString);
        return path$1.basename(url.pathname);
    }
    catch (_a) {
        // If URL parsing fails, return an empty string
        return '';
